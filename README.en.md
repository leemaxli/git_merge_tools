...
**Current version v7.2** · see [Version history](#version-history) below
...
> Current version: **v7.2**. Early v1–v3 predate Git tracking and are a summarized retrospective;

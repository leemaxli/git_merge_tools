...
[Diagnostics.CodeAnalysis.SuppressMessageAttribute(
    ...
    Scope = 'Function',
    Target = '*',
    Justification = 'This module contains the standard visual renderer for interactive git tools.'
)]
param()

function New-GitMergeToolsVisualStandard {
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute(
        'PSUseShouldProcessForStateChangingFunctions',
        '',
    ...
    $context = New-GitMergeToolsVisualContext -CommandName $CommandName -VisualLevel 'standard' -RequestedVisualMode $RequestedVisualMode -RichUnavailableReasons $RichUnavailableReasons -VisualWarningSuppressed:$VisualWarningSuppressed
    $theme = $context.Theme
    ...
    $writeStage = {
        ...
        Write-Host ''
        Write-Host ("  ━━━━━━━━  {0}  {1}  ━━━━━━━━" -f $StageIcon, $Title) -ForegroundColor $Color
...
Export-ModuleMember -Function New-GitMergeToolsVisualStandard
